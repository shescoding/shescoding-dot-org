...
Persona.find_or_create_by!(name: 'woman', color: '#DB2C38;', description: 'A person identifying as female',
	questions: <<-QQQ
	  [	{'answer': 'woman', 'nextQuestions': [
					{'answer': 'already in tech', 'nextQuestions': [
							{'answer': 'advance my career', 'guide': 'tech_woman_career'},
							{'answer': 'learn how to diversify my work environment', 'guide': 'tech_woman_diversify'},
							{'answer': 'become an advocate', 'guide': 'tech_woman_advocate'}]
					},
		  		{'answer': 'interested in tech', 'nextQuestions': [
						{'answer': 'become a coder', 'guide': 'woman_coder'},
						{'answer': 'find a job', 'guide': 'woman_job'}
					]},

					{'answer': 'become an advocate', 'guide': 'woman_advocate'},

					{'answer': 'learn how to get into the gaming industry', 'guide': 'woman_gamer'}
				},
				{'answer': 'girl', 'nextQuestions': [
					{'answer': 'learn how to code', 'guide': 'girl_coder'},
					{'answer': 'find interesting projects and groups', 'guide': 'tech_girl'},
					{'answer': 'learn how to build my own games', 'guide': 'girl_gamer'}
				]}
		]
	QQQ
	)
