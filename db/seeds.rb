...
tag_list = ['advice', 'advocacy', 'African-American', 'after-school programs', 'allies', 
    ...
    'confidence', 'corporate training', 'creative skills', 'culture', 'discrimination lawsuit', 
    ...
    'gender equalit', 'gender gap', 'gender stereotypes', 'girls', 'global', 'grants', 'hackathons', 
